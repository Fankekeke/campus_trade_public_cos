...
import drugAdd from './GoodsAdd.vue'
import drugEdit from './GoodsEdit.vue'
import drugView from './GoodsView.vue'
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/stock/drug-info/' + ids).then(() => {
